...
export default function AddServiceScreen() {
  ...
  const handleAddService = async () => {
    ...
    try {
      ...
      // and then use the returned URL in the service creation
      ...
      const serviceData = {
        ...
        requirements,
        imageUrl: imageUri || "https://images.unsplash.com/photo-1584982751601-97dcc096659c?q=80&w=2072&auto=format&fit=crop",
      };
      ...
      Alert.alert("Error", (error as Error).message || "Failed to create service");
    } finally {
      setLoading(false);
    }
  };
    ...
    <SafeAreaView style={styles.container} edges={["bottom"]}>
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Create a new medical service</Text>
        </View>
